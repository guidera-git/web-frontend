                ...
                <div className="col-lg-6">
                  <div className="card-body ">
                    <div className="col-md d-flex align-items-center justify-content-center flex-column p-4 text-light ">
                      <h2 className="p-1">Welcome <span className="text-primary">Back</span></h2>
                      <h4 className="p-1">Log into your Account</h4>
                      <button className="btn google-btn  d-flex align-items-center justify-content-center rounded-pill">
                        <img
                          src="/google.svg"
                          alt="Google Logo"
